...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Serial.name'
        db.delete_column(u'core_serial', 'name')

        # Adding field 'Serial.serial'
        db.add_column(u'core_serial', 'serial',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Serial.name'
        raise RuntimeError("Cannot reverse this migration. 'Serial.name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Serial.name'
        db.add_column(u'core_serial', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=20, unique=True),
                      keep_default=False)

        # Deleting field 'Serial.serial'
        db.delete_column(u'core_serial', 'serial')
    ...
    models = {
        ...
        u'core.serial': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'max_length': '16', 'primary_key': 'True'}),
            'serial': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'})
        },
        u'core.server': {
